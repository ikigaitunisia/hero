    ...
    <>
      <li>
        ...
        <div className="in" style={{ textAlign: "start", marginLeft: "20px" }}>
          <div className="blue">
            <div className="">
              <strong>UK Climate Justice Circle</strong>
            </div>
            <div className="mb-05">
              <span>@UK Climate Justice Circle</span>
            </div>
            <div className="text-xsmall">
              Welcome to the Circle. We are thrilled to have you amongst our
              supporters. Stay tuned for updates about the projects we are
              working on !
            </div>
          </div>
