...
function ActivistCampaignsDesktopModal(props) {
  useEffect(() => {
    if (props.show) {
                          ...
                          >
                            <div className="white-text">
                              ...
                              <div className="text-xsmall">
                                Drafting a new law to present to the EU
                                Parliament to protect climate refugees.
                              </div>
                            </div>
                          </div>
                        </div>
                        <div style={{ display: "flex" }} className="mt-2">
                          ...
                          >
                            <div className="white-text">
                              ...
                              <div className="text-xsmall">
                                Organizing mobilizations to put pressure on
                                Belgium’s goberment to close coal mines.
                              </div>
                            </div>
                          </div>
                        </div>
...
export default ActivistCampaignsDesktopModal;
