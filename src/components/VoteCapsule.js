...
function VoteCapsule(props) {
  return (
    <div id="appCapsule" className="bg-g" style={{ minHeight: "100vh" }}>
      <div className="section custom-width center-div-2 white-text mt-4">
      ...
      <div className="section center-div-2 mt-2">
      ...
      <div className="section mt-3 center-div-2">
        <div className="row">
      ...
      <div className="section center-div-2">
        <h3 className="white-text">Voting ends in:</h3>
        <div
          className="row wallet-card custom-padding mt-3"
        >
